...
class SCNetWaveMFFMConcat(nn.Module):
    def __init__(self, input_shape):
        super(SCNetWaveMFFMConcat, self).__init__()
        self.mffm_block1 = MFFMBlock(50)
        self.wave_block1 = WaveBlock(50, 32, 3, 5)
        self.mffm_block2 = MFFMBlock(32)
        self.wave_block2 = WaveBlock(32, 32, 3, 3)
        self.mffm_block3 = MFFMBlock(32)
        self.conv1 = nn.Conv1d(in_channels=106, out_channels=32, kernel_size=3, padding=1)
        self.bn1 = nn.BatchNorm1d(50)
        self.conv2 = nn.Conv1d(in_channels=88, out_channels=32, kernel_size=3, padding=1)
